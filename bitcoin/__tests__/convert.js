...
test('should convert a NaN to a Number', () => {
  expect(convert(NaN, 'BTC', 'BTC', 'Number')).toBeDefined();
  expect(convert(NaN, 'BTC', 'mBTC', 'Number')).toBeDefined();
});

test('should convert a NaN to a String', () => {
  expect(convert(NaN, 'BTC', 'BTC', 'String')).toBeDefined();
  expect(convert(NaN, 'BTC', 'mBTC', 'String')).toBeDefined();
});
